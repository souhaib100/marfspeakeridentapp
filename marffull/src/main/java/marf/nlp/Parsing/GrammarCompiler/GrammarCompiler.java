...
public class GrammarCompiler
    ...
    protected String getNextRHSToken()
        ...
        if (this.oToken.getTokenType().getSubtype() == GrammarTokenType.GRAMMAR_EOL) {
        ...
        throw new SyntaxError
                (
                        "Unexpected grammar token type.\n"
                                ...
                                + GrammarTokenType.soTokenSubTypes.get(new Integer(this.oToken.getTokenType().getSubtype()))
                );
    }
