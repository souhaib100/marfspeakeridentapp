...
/*		catch(StorageException e)
    ...
    protected void createRule()
        ...
        // Must be ::=
        if (this.oToken.getTokenType().getSubtype() != ProbabilisticGrammarTokenType.RULE_OP) {
            throw new SyntaxError
                    (
                            "ProbabilisticGrammarCompiler::createRule() - ERROR: Expected rule operator (::=), but got: " +
                                    this.oToken.getLexeme() +
                                    ", subtype: " + this.oToken.getTokenType().getSubtype() +
        ...
        if (this.oToken.getTokenType().getSubtype() != ProbabilisticGrammarTokenType.NUM) {
            throw new SyntaxError
                    (
