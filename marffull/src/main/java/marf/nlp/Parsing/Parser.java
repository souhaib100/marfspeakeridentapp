	...
	//*/
                    ...
                    if
                        ...
                        // Either keywords and other language symbols
                            (oTopElement.getName().compareTo(oNextToken.getLexeme()) == 0)

                                    ||

                                    // Or user-defined IDs
                                    (
                                            (oTopElement.getName().compareTo("ID") == 0)
                                                    &&
                                    ...
                                    // NUM
                                    (
                                            (oTopElement.getName().compareTo("NUM") == 0)
                                                    &&
                                    ...
                                    // INTEGER
                                    (
                                            (oTopElement.getName().compareTo("INTEGER") == 0)
                                                    &&
        ...
        return (oNextToken.getTokenType().iType == TokenType.EOF) && !this.bErrorsPresent;
